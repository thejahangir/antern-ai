      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center mb-12 border-b border-gray-100 pb-12">
          ...
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-4 mb-6 md:mb-0">
            {navLinks.map((link) => (
              <a 
                ...
                className="text-sm font-medium text-brand-black/60 hover:text-brand-black transition-colors"
              >
                {link}
              </a>
            ))}
          ...
          <div className="flex space-x-4">
            <a href="#" className="text-brand-black/40 hover:text-brand-blue transition-colors">
        ...
        <div className="flex justify-center items-center text-sm text-brand-black/40">
          <p className="text-center">&copy; {new Date().getFullYear()} AnternAI Inc. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
